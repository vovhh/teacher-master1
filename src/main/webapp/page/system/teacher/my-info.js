layui.use(['element', 'form', 'table', 'layer', 'laytpl', 'util'], function () {
    ...
    $.ajax({
        type: "POST",
        url: '/teacher/biz/teacher_findById.action',//数据接口
    ...
    var paperInfoList = table.render({
        ...
        url: '/teacher/biz/paper_findByAuthor.action?teacherId=' + teacherId,//数据接口
        page: true,//开启分页
    ...
    var matchInfoList = table.render({
        ...
        url: '/teacher/biz/match_findByTeacher.action?teacherId=' + teacherId,//数据接口
        page : true,//开启分页
        height : "full-125",//容器高度
        limits : [10,15,20,25],
        limit : 20,
    ...
    var stuCompetitionList = table.render({
        ...
        url: '/teacher/biz/competition_findByTeacher.action?matchAttribute=1&teacherId='+teacherId,//数据接口
        page : true,//开启分页
        height : "full-125",//容器高度
        limits : [10,15,20,25],
        limit : 20,
    ...
    var teaCompetitionList = table.render({
        ...
        url: '/teacher/biz/competition_findByTeacher.action?matchAttribute=2&teacherId='+teacherId,//数据接口
        page : true,//开启分页
        height : "full-125",//容器高度
        limits : [10,15,20,25],
        limit : 20,
    ...
    var teacherItemInfoList = table.render({
        ...
        url: '/teacher/biz/teacherItem_findByPerson.action?itemPersonId='+teacherId,//数据接口
        page : true,//开启分页
        height : "full-125",//容器高度
        limits : [10,15,20,25],
        limit : 20,
    ...
    var teacherHonorInfoList = table.render({
        ...
        url: '/teacher/biz/teacherHonor_findByPerson.action?teacherId='+teacherId,//数据接口
        page : true,//开启分页
        height : "full-125",//容器高度
        limits : [10,15,20,25],
        limit : 20,
    ...
    var teachingMaterialInfoList = table.render({
        ...
        url: '/teacher/biz/teachingMaterial_findByEditor.action?teacherId='+teacherId,//数据接口
        page : true,//开启分页
        height : "full-125",//容器高度
        limits : [10,15,20,25],
        limit : 20,
    ...
    var teachingResultInfoList = table.render({
        ...
        url: '/teacher/biz/teachingResult_findByPerson.action?teacherId='+teacherId,//数据接口
        page : true,//开启分页
        height : "full-125",//容器高度
        limits : [10,15,20,25],
        limit : 20,
