layui.use(['form','layer','table','laytpl','util'],function(){
    ...
    var tableIns = table.render({
        ...
        url: '/teacher/biz/teacher_findDeptAdmin.action?',//数据接口
        cellMinWidth : 95,
        page: true,//开启分页
        ...
        cols: [[//表头
            ...
            {field: 'teacherCode', title: '管理员工号', minWidth: 100, align: "center"},
            {field: 'teacherName', title: '管理员姓名', minWidth: 100, align: 'center'},
            ...
            {field: 'roleName', title: '管理员角色', minWidth: 200, align: 'center'},
        ...
        var index = layui.layer.open({
            ...
            success: function (layero, index) {
                ...
                if (edit) {
                    ...
                    body.find(".deptHide").val(edit.deptId);  //使用中间变量保存部门id
