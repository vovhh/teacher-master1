layui.use(['form','layer','table','laytpl','util'],function(){
    ...
    var tableIns = table.render({
        ...
        url: '/teacher/biz/teacher_findByDept.action?teacherId=' + teacherId,//数据接口
        cellMinWidth : 95,
        page: true,//开启分页
        ...
        cols: [[//表头
            ...
            {field: 'roleName', title: '教师角色', minWidth: 200, align: 'center'},
    ...
    function detailUser(data) {
        var index = layui.layer.open({
            title: "详情",
            type: 2,
            content: "../teacher/teacher-detail.html",
            success: function (layero, index) {
                var body = layui.layer.getChildFrame('body', index);
