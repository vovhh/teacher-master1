layui.config({
    ...
    var teacherCode = window.sessionStorage.getItem("teacherCode");
    //信息列表
    var tableLoad = layer.load(1);
    var tableIns = table.render({
        elem: '#infoList',//数据表格id
        url: '/teacher/biz/teacherItem_findByMember.action?teacherCode='+teacherCode,//数据接口
        page : true,//开启分页
                ...
                success: function (res) {
                    if (res.code===0){
                        ...
                        data.unshift({itemId: '编号', itemName: '项目名称', itemPerson: '主持人', itemType: '项目类型',
                            ...
                            memberName: '项目成员', contractNumber: '合同编号', startTime: '起始时间', endTime: '结束时间'});
                        excel.exportExcel({
                            sheet1: data
                        }, '我参与的教师项目.xlsx', 'xlsx');
                    }else {
