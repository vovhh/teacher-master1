layui.use([ 'form', 'layer', 'upload', 'laydate'], function () {
    ...
    form.on("submit(addUser)", function (data) {
        ...
        // 实际使用时的提交信息
        $.post(updateFlag === '0' ? "/teacher/biz/match_save.action" : "/teacher/biz/match_update.action", {
            ...
            matchAttribute: data.field.matchAttribute,    //赛事属性
    ...
    var demoListView = $('#demoList'),
        uploadListIns = upload.render({
            elem: '#testList',
            // url: '/teacher/upload_uploadMatchFile.action',
    ...
    // 附件上传要求--添加验证规则
    form.verify({
        userFile: function (value) {if (value == null || value=="") return "请上传赛事信息附件！";}
    })
});