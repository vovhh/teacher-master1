layui.use(['form', 'layer', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        url: '/teacher/biz/competitionPrizeGrade_findByPage.action',//数据接口
        page: true,//开启分页
        ...
        cols: [[//表头
            ...
            {field: 'title', title: '竞赛获奖等次', minWidth: 100, align: 'center'},
    ...
    table.on('tool(infoList)', function (obj) {
        ...
        if (layEvent === 'edit') { //编辑
            ...
            layer.confirm('确定删除此竞赛获奖等次？', {icon: 3, title: '提示信息'}, function (index) {
                $.get("/teacher/biz/competitionPrizeGrade_delete.action", {
