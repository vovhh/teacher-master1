layui.config({
    ...
    var tableIns = table.render({
        ...
        url: '/teacher/biz/competition_findByDeptStu.action?deptId='+deptId,//数据接口
        page : true,//开启分页
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.code===0){
                        ...
                        data.unshift({itemId: '编号', match: '赛事名称', itemName: '作品名称', teacher: '指导老师', awardee: '参赛队员', prizeTime: '获奖时间', prizeLevel: '获奖级别', prizeGrade: '获奖等次'});
        ...
        var index = layui.layer.open({
            ...
            success : function(layero, index){
                ...
                if(edit){
                    ...
                    body.find('#workName1').html("作品名称");
                    body.find('#workName2').html("指导老师");
    ...
    function detailUser(data) {
        var index = layui.layer.open({
            ...
            success: function (layero, index) {
                ...
                body.find('#workName1').html("作品名称");
                body.find('#workName2').html("指导老师");
                body.find(".teacherName").val(data.teacher.teacherName);//指导老师
