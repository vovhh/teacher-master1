layui.use(['form','layer','table'],function(){
    ...
    var tableIns = table.render({
        ...
        url: '/teacher/biz/student_findByRace.action?itemId='+thisRaceItemId,//数据接口
        page : true,//开启分页
    ...
    table.on('tool(infoList)', function (obj) {
        ...
        if(layEvent === 'edit'){ //编辑
            ...
            layer.confirm('确定删除此记录？',{icon:3, title:'提示信息'},function(index){
                $.get("/teacher/biz/student_delete.action",{
    ...
    $(".delBtn").click(function(){
        ...
        if(data.length > 0) {
            ...
            layer.confirm('确定删除选中记录？', {icon: 3, title: '提示信息'}, function (index) {
                $.post("/teacher/biz/student_deleteBatch.action",{
        ...
        var index = layui.layer.open({
            ...
            success : function(layero, index){
                ...
                if(edit){
                    ...
                    body.find(".isPerson input[value="+edit.isPerson+"]").prop("checked","checked");  //主持人
