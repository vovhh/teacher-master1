layui.config({
    ...
    var tableIns = table.render({
        ...
        url: '/teacher/biz/competition_findByPage.action',//数据接口
        page : true,//开启分页
        ...
        cols : [[//表头
            ...
            {field: 'itemName', title: '比赛科目/作品名称', minWidth:100, align:"center"},
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.code===0){
                        ...
                        data.unshift({itemId: '编号', match: '赛事名称', itemName: '比赛科目/作品名称', teacher: '主持人', awardee: '参赛队员', prizeTime: '获奖时间', prizeLevel: '获奖级别', prizeGrade: '获奖等次'});
        ...
        var index = layui.layer.open({
            ...
            success : function(layero, index){
                ...
                if(edit){
                    ...
                    body.find('#workName1').html("比赛科目/作品名称");
