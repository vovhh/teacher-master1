layui.use(['form', 'layer', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        url: '/teacher/biz/dept_findByPage.action',//数据接口
        page: true,//开启分页
    ...
    table.on('tool(infoList)', function (obj) {
        ...
        if (layEvent === 'edit') { //编辑
            ...
            layer.confirm('确定删除此部门？', {icon: 3, title: '提示信息'}, function (index) {
                $.get("/teacher/biz/dept_delete.action", {
            ...
            success: function (layero, index) {
                ...
                if (edit) {
                    ...
                    if (edit.parent==null) {
                        ...
                        body.find(".parent").prop("disabled", true);
                    } else {
                        body.find(".parentHide").val(edit.parent.deptId);//使用中间变量保存上级部门id
                    }
