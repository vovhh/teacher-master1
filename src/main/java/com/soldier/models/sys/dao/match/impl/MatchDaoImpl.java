package com.soldier.models.sys.dao.match.impl;

import com.soldier.common.vo.PageBean;
import com.soldier.models.sys.dao.match.MatchDao;
...
public class MatchDaoImpl implements MatchDao {
    ...
    public boolean checkMatch(MatchEntity matchEntity) {
        ...
        criteria.add(Restrictions.eq("matchName", matchEntity.getMatchName()));
        criteria.add(Restrictions.eq("matchLevel", matchEntity.getMatchLevel()));
        criteria.add(Restrictions.eq("matchType", matchEntity.getMatchType()));
        criteria.add(Restrictions.eq("matchAttribute", matchEntity.getMatchAttribute()));
