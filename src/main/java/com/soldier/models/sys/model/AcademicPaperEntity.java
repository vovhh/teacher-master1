...
public class AcademicPaperEntity {
    ...
    private String memberCode;//成员，多个
    ...
    @Override
    public int hashCode() {
        return Objects.hash(paperId, paperName, paperType, paperTitle, teacherType, signUnit, periodicalName, periodicalNumber, publishTime, memberCode, memberName, updateTime);
    }
