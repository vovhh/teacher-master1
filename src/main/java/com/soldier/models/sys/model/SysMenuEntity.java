 ...
 */
@Entity
@Table(name = "sys_menu", schema = "teacher_files", catalog = "")
...
//    private String roleType;
    ...
    private Set<SysRoleEntity> roleSet;
...
//                roleType == that.roleType &&
    ...
    public Set<SysRoleEntity> getRoleSet() {
        return roleSet;
    }

    public void setRoleSet(Set<SysRoleEntity> roleSet) {
