...
//    private Set<TeacherItemEntity> researchSet;//科研项目
    ...
    @Override
    public int hashCode() {
        return Objects.hash(teacherId, teacherCode, teacherName, teacherSex, teacherBirth, teacherImg,
                highEdu, firstEdu, technicalPost, administPost, teacherResume, other, roleId, roleName,
                unitIds, deptId, deptName, updateTime);
    }
