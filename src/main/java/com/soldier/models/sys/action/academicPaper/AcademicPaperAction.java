package com.soldier.models.sys.action.academicPaper;
...
import com.soldier.models.sys.model.AcademicPaperEntity;
import com.soldier.models.sys.model.AcademicPaperGradeEntity;
import com.soldier.models.sys.model.TeacherEntity;
import com.soldier.models.sys.service.academicPaper.AcademicPaperService;
import com.soldier.models.sys.service.academicPaperAnnex.AcademicPaperAnnexService;
import com.soldier.models.sys.service.academicPaperGrade.AcademicPaperGradeService;
...
public class AcademicPaperAction extends ActionSupport implements ModelDriven<AcademicPaperEntity> {
    ...
    public String save() {
        ...
        academicPaperEntity.setUpdateTime(new java.sql.Date(new Date().getTime()));
//        academicPaperEntity.setPublishTime(new java.sql.Date(DateUtil.string2Date(paperPublishTime,"yyyy-MM-dd").getTime()));
        academicPaperEntity.setPublishTime(paperPublishTime);
        ...
        teacher_result.setTeacherCode(teacherCode);
        teacher_result = teacherService.findByTeacherCode(teacher_result);
        academicPaperEntity.setTeacher(teacher_result);
