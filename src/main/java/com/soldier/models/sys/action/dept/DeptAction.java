package com.soldier.models.sys.action.dept;
...
public class DeptAction extends ActionSupport implements ModelDriven<DeptEntity> {
    ...
    public String save() {
        ...
        if (parentId!=null && parentId!="") {
            ...
            dept_result.setDeptId(Long.valueOf(parentId));
            dept_result = deptService.findById(dept_result);
            deptEntity.setParent(dept_result);
        }

        deptEntity.setDeptId(IDUtils.genItemId());
    ...
    public String update() {
        ...
        teacherService.updateTeacherDeptName(deptEntity);
        competitionService.updateCompetitionDeptName(deptEntity);
    ...
    public String findAllParent() {
        ...
        List<DeptEntity> list = deptService.findAllParent();
