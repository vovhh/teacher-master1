package com.soldier.models.sys.action.match;

import com.opensymphony.xwork2.ActionSupport;
import com.opensymphony.xwork2.ModelDriven;
import com.soldier.common.vo.PageBean;
import com.soldier.common.vo.R;
import com.soldier.models.sys.model.MatchAnnexEntity;
...
import com.soldier.models.sys.service.matchAnnex.MatchAnnexService;
...
//    private String theMatchTime;
    ...
    public String save() {
        ...
        if (!matchService.checkMatch(matchEntity)) {

            matchEntity.setUpdateTime(new java.sql.Date(new Date().getTime()));
