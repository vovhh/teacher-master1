package com.soldier.models.sys.action.upload;

import com.opensymphony.xwork2.ActionSupport;
import com.soldier.common.config.ConfigApi;
...
// :/usr/local/apache-tomcat-8.5.38/webapps/teacher/sysFile
 */
public class UploadAction extends ActionSupport {
    ...
    public String uploadTeacherImg() {
        ...
        String projectPath = ServletActionContext.getServletContext().getContextPath();//等于 /teacher
...
//        String realPath = ServletActionContext.getServletContext().getRealPath("/upload/prizeImg");
        String projectName = ServletActionContext.getServletContext().getContextPath();//等于 /teacher
